 ...
 * nsosx.c --
 *
 *	Routines missing from OS/X. This object file should be linked into
 *	libtcl.dylib and a COMPAT_OBJS.  Everything is in one file to ensure
 *	it's all pulled into libtcl for the benefit of nsd.
 */

static const char *RCSID = "@(#) $Header: /Users/dossy/Desktop/cvs/aolserver/nsosx/Attic/nsosx.c,v 1.1 2002/06/05 23:00:51 jgdavidson Exp $, compiled: " __DATE__ " " __TIME__;
