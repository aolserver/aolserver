...
#
# $Header: /Users/dossy/Desktop/cvs/aolserver/nssock/Attic/keygen.tcl,v 1.1 2000/07/13 18:43:54 kriston Exp $
#
    ...
    while {[string length $str] > 0} {
        ...
        set p 0
            ...
            incr p
                ...
                set value [osi_asn1_to_list [string range $str 0 [expr $p-1]]]
