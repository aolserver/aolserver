...
static const char *RCSID = "@(#) $Header: /Users/dossy/Desktop/cvs/aolserver/nslog/nslog.c,v 1.1.1.1 2000/05/02 13:48:23 kriston Exp $, compiled: " __DATE__ " " __TIME__;
...
LogFlush(Log *logPtr, Ns_DString *dsPtr)
{
    if (dsPtr->length > 0) {
	    ...
	    Ns_Log(Error, "nslog: logging disabled");
	    close(logPtr->fd);
	    logPtr->fd = -1;
	}
