...
#define TclpAlloc(size)		Ns_Malloc(size)
#define TclpFree(ptr)		Ns_Free(ptr)
#define TclpRealloc(ptr, size)	Ns_Realloc(ptr, size)
...
#define TclpGetDate(t,u) ((u) ? ns_gmtime((t)) : ns_localtime((t)))
#define TclStrftime(s,m,f,t) (strftime((s),(m),(f),(t)))

/*
 * AOLserver thread safe function macros.
 */

#define signal ns_signal
#define readdir ns_readdir
