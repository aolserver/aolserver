...
static const char *RCSID = "@(#) $Header: /Users/dossy/Desktop/cvs/aolserver/tcl7.6/generic/Attic/tclClock.c,v 1.1.1.1 2000/05/02 13:48:26 kriston Exp $, compiled: " __DATE__ " " __TIME__;
...
static Tcl_CmdProc	Tcl_ClockCmd2;
...
static int
Tcl_ClockCmd2(dummy, interp, argc, argv)
    ...
    char **argv;			/* Argument strings. */
{
    ...
    Ns_MutexLock(&lock);
    code = Tcl_ClockCmd2(dummy, interp, argc, argv);
    Ns_MutexUnlock(&lock);
    return code;
}

