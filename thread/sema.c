 ...
 *
 *	Note:  Semaphores are almost always a bad idea.  In general, cleaner
 *	and more flexible code can be implemented with condition variables
 *	instead.  Indeed, the semaphores below are implmented using
 *	condition variables indicating that condition variables are the
 *	more fundamental synchronization object. 
 */

static const char *RCSID = "@(#) $Header: /Users/dossy/Desktop/cvs/aolserver/thread/Attic/sema.c,v 1.1.1.1 2000/05/02 13:48:40 kriston Exp $, compiled: " __DATE__ " " __TIME__;
