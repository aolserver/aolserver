...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /I "..\..\tcl8.4\generic" /I "..\..\include" /D "_CONSOLE" /D "NDEBUG" /D "WIN32" /D "_MBCS" /D FD_SETSIZE=128 /D TCL_THREADS=1 /YX /FD /c
...
# ADD LINK32 nsd.lib /nologo /subsystem:console /debug /machine:I386 /libpath:"..\nsd\release" /OPT:REF
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=for %%m in (exe) do copy release\main.%%m ..\release\nsd.%%m
...
# ADD LINK32 nsd.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"..\nsd\debug"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=for %%m in (exe) do copy debug\main.%%m ..\debug\nsd.%%m
# End Special Build Tool
