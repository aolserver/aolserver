...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "..\..\include" /I "c:\files\bsafe\include" /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL" /D "NSSSL_EXPORTS" /D "WIN32" /D "_MBCS" /D FD_SETSIZE=128 /D SSL=1 /D SSL_DOMESTIC=1 /Fp"Release/nssssl.pch" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\include" /I "c:\files\bsafe\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_USRDLL" /D "NSSOCK_EXPORTS" /D "_MBCS" /D FD_SETSIZE=128 /D SSL=1 /D SSL_DOMESTIC=1 /Fp"Debug/nssock.pch" /YX /FD /GZ /c
# SUBTRACT CPP /X
...
# ADD LINK32 ..\nsthread\debug\nsthread.lib ..\nsd\debug\nsd.lib ..\nstcl\debug\nstcl.lib kernel32.lib wsock32.lib c:\files\bsafe\lib\bsafe.lib /nologo /dll /debug /machine:I386 /out:"Debug/nsssle.dll" /pdbtype:sept
